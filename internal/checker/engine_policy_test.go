...
func TestPolicyCheckRepo_AbsentMode_Phase1(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if _, err := parityCheckRepo(context.Background(), t, engine, client, "org", "repo"); err != nil {
				t.Fatalf("CheckRepo: %v", err)
			}
...
func TestPolicyCheckRepo_BackwardCompatibility(t *testing.T) {
	...
	if _, err := parityCheckRepo(context.Background(), t, policyEngine, policyClient, "org", "repo"); err != nil {
		t.Fatalf("policy CheckRepo: %v", err)
	}

	if _, err := parityCheckRepo(context.Background(), t, registryEngine, registryClient, "org", "repo"); err != nil {
...
func TestIntegration_HCLConfigWithCustomPropertiesReconciler(t *testing.T) {
	...
	_, err := parityCheckRepo(context.Background(), t, engine, client, "org", "my-service")
	if err != nil {
		t.Fatalf("CheckRepo: %v", err)
	}
...
func TestGlobalIgnoreList_SkipsAllRules(t *testing.T) {
	...
	_, err := parityCheckRepo(context.Background(), t, engine, client, "org", "ignored-repo")
	if err != nil {
		t.Fatalf("CheckRepo: %v", err)
	}
...
func TestGlobalIgnoreList_GlobPattern(t *testing.T) {
	...
	_, err := parityCheckRepo(context.Background(), t, engine, client, "org", "terraform-vpc")
	if err != nil {
		t.Fatalf("CheckRepo: %v", err)
	}
...
func TestGlobalIgnoreList_NoMatchStillProcesses(t *testing.T) {
	...
	_, err := parityCheckRepo(context.Background(), t, engine, client, "org", "my-repo")
	if err != nil {
		t.Fatalf("CheckRepo: %v", err)
	}
...
func TestPerRuleIgnoreList_SkipsOnlyThatRule(t *testing.T) {
	...
	_, err := parityCheckRepo(context.Background(), t, engine, client, "org", "special-repo")
	if err != nil {
		t.Fatalf("CheckRepo: %v", err)
	}
...
func TestPerRuleIgnoreList_ReconcilerAlsoSkipped(t *testing.T) {
	...
	_, err := parityCheckRepo(context.Background(), t, engine, client, "org", "ignored")
	if err != nil {
		t.Fatalf("CheckRepo: %v", err)
	}
...
func TestIntegration_IgnoreLists_SettingRules_BranchProtection(t *testing.T) {
	...
	if _, err := parityCheckRepo(context.Background(), t, engine, ignoredClient, "org", "globally-ignored"); err != nil {
	...
	if _, err := parityCheckRepo(context.Background(), t, engine, normalClient, "org", "normal-repo"); err != nil {
