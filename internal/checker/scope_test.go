...
func TestPolicyEngine_LegacyMode_NoScopeFiltering(t *testing.T) {
	...
	if _, err := parityCheckRepo(context.Background(), t, engine, client, "anyorg", "repo"); err != nil {
...
func TestPolicyEngine_StrictMode_PolicyScopeRejectsRepo(t *testing.T) {
	...
	if _, err := parityCheckRepo(context.Background(), t, engine, client, "otherorg", "repo"); err != nil {
		t.Fatalf("CheckRepo: %v", err)
	}
...
func TestPolicyEngine_StrictMode_RuleUniversalApplies(t *testing.T) {
	...
	if _, err := parityCheckRepo(context.Background(), t, engine, client, "myorg-prod", "repo"); err != nil {
		t.Fatalf("CheckRepo: %v", err)
	}
...
func TestPolicyEngine_StrictMode_RuleSubsetApplies(t *testing.T) {
	...
	if _, err := parityCheckRepo(context.Background(), t, engine, client, "myorg-staging", "repo"); err != nil {
		t.Fatalf("CheckRepo: %v", err)
	}
...
func TestPolicyEngine_StrictMode_InScopeButIgnored(t *testing.T) {
	...
	if _, err := parityCheckRepo(context.Background(), t, engine, client, "myorg-prod", "skipped"); err != nil {
		t.Fatalf("CheckRepo: %v", err)
	}
...
func TestPolicyEngine_StrictMode_OutOfScopeCounterByLevel(t *testing.T) {
	...
	if _, err := parityCheckRepo(context.Background(), t, engine, policyClient, "external", "repo"); err != nil {
	...
	if _, err := parityCheckRepo(context.Background(), t, engine, ruleClient, "myorg-staging", "repo"); err != nil {
