...
.PHONY: lint lint-fix lint-alerts lint-alerts-contrib lint-alerts-chart fmt clean
...
lint-alerts: lint-alerts-contrib lint-alerts-chart ## Validate Prometheus alert rules (contrib recipe + rendered chart)

lint-alerts-contrib: ## Validate the standalone alert recipe in contrib/prometheus/
	@ $(MAKE) --no-print-directory log-$@
