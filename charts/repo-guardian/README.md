...
| posture | object | `{"exportInterval":"60s"}` | Compliance posture export (IMPL-0023 / DESIGN-0022). The elected leader projects the rule_state table onto the repos_actionable / repos_tracked / repos_unmeasurable gauges on this cadence. |
